...
public class Analyzer {
    ...
    private static String[] testSentences = {"@BryanaLaChae nooo, you gotta see it on! i don't want to spoil it! ?? but i'm wearing those steven madden heels you don't like!",
